...
const emptyInputNotice = document.querySelector(".emptyInputNotice");
...
function allThatHappens() {
   ...
   if (taskText.trim().length === 0) {
      emptyInputNotice.textContent = `Input must not be empty`;
   ...
   spanInLi.addEventListener("click", () => {
         ...
         //update score
         completedScoreNotice.textContent = `${completedScore} completed`;
      }
   )
   ...
   trashbin.innerHTML = `
   <!-- Vectors and icons by <a href="https://github.com/IonutNeagu?ref=svgrepo.com" target="_blank">Ionutneagu</a> in PD License via <a href="https://www.svgrepo.com/" target="_blank">SVG Repo</a> -->
